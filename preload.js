...
const api = {
  ...
  setTabPinned: (id, pinned) => ipcRenderer.invoke('set-tab-pinned', { id, pinned }),
  ...
  startFocusSession: (details) => ipcRenderer.invoke('start-focus-session', details),
  pauseFocusSession: () => ipcRenderer.invoke('pause-focus-session'),
  resumeFocusSession: () => ipcRenderer.invoke('resume-focus-session'),
  cancelFocusSession: () => ipcRenderer.invoke('cancel-focus-session'),
